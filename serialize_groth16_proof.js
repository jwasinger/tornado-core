...
function serialize_f1(num) {
    if (num.length == 3)  {
        return num_to_hex_fq(num[0]) + num_to_hex_fq(num[1]) + num_to_hex_fq(num[2])
    } else if (num.length == 2) {
        return num_to_hex_fq(num[0]) + num_to_hex_fq(num[1])
    } else {
...
function serialize_f2(num) {
    return serialize_f1(num[0]) + serialize_f1(num[1]) + num_to_hex_fq(num[2][0], 64) + num_to_hex_fq(num[2][1], 64)
}
